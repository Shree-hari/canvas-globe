...
description: Generate OG images, LinkedIn cards and story graphics from real data — headline, logo and globe baked into one PNG by a single call to exportImage.
keywords:
  - generate og image
