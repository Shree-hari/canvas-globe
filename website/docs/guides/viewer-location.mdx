...
```js
import { locateViewer, timeZoneLocation, countryLocation, placeLocation } from "@swiftools/geo-globe";
...
bundled table. There is no request, no third party, and nothing to disclose in a cookie banner —
though if you send the result to your own analytics, that is your call to document.
