...
`3d-world-map`, `3d-maps`, and `3d-globe-map` are alternate discovery entries
...
| [`3d-world-map`](https://www.npmjs.com/package/3d-world-map) | 3D world-map discovery entry for the canonical API |
| [`3d-maps`](https://www.npmjs.com/package/3d-maps) | Broad 3D maps discovery entry for the canonical API |
