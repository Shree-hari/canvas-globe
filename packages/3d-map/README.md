...
[![npm version](https://img.shields.io/npm/v/3d-map.svg)](https://www.npmjs.com/package/3d-map)
[![npm downloads](https://img.shields.io/npm/dm/3d-map.svg)](https://www.npmjs.com/package/3d-map)
...
`3d-map` is an official package entry for
[CanvasGlobe](https://canvasglobe.swiftools.com/), an interactive JavaScript 3D
globe and world-map library rendered with Canvas 2D. It provides the same API,
...
```js
import { createGlobe } from "3d-map";
...
```js
import { aurora, routeDashes } from "3d-map/fx";
import { tilegram } from "3d-map/charts";
import { applyRecipe, keynoteGlobe } from "3d-map/recipes";
...
```jsx
import { Globe } from "3d-map/react";
...
| Import | Purpose |
| --- | --- |
| `3d-map` | Core renderer, data helpers, projections, markers, routes, and exports |
| `3d-map/element` | Framework-independent custom element |
| `3d-map/react` | React component |
| `3d-map/fx` | Visual, camera, transition, and data effects |
| `3d-map/fx/interaction` | Advanced pointer and selection interactions |
| `3d-map/charts` | Animated geographic chart layers |
| `3d-map/recipes` | Complete composed visual treatments |
| `3d-map/controls` | Search, timeline, threshold, and crossfilter bindings |
| `3d-map/places` | Searchable bundled place data |
| `3d-map/data/world` | Bundled world geometry |
